        ...
        <div className="mt-12">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                            <img
                                key={`star-${i}`}
                                src={i < 4 ? assets.star_icon : assets.star_dull_icon} alt="" className='md:w-4 w-3.5' />
                        ))}
            ...
            <div className='flex flex-col items-center mt-20'>
                ...
                <button onClick={() => {
                    ...
                    className='mx-auto cursor-pointer text-primary px-12 my-16 py-2.5 border-rounded rounded-full border border-primary hover:bg-primary/10 transition'>
                    See more
                </button>
            </div>
        </div>
